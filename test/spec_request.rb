...
describe Rack::Request do
  ...
  should "parse the query string" do
    req = Rack::Request.new(Rack::MockRequest.env_for("/?foo=bar&quux=bla&withoutvalue"))
    req.query_string.should.equal "foo=bar&quux=bla"
    req.GET.should.equal "foo" => "bar", "quux" => "bla", "withoutvalue" => ""
    req.POST.should.be.empty
    req.params.should.equal "foo" => "bar", "quux" => "bla", "withoutvalue" => ""
  end
